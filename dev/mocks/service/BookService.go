...
func (_m *BookService) Create(ctx context.Context, book dto.BookCreateDTO) (entity.Book, error) {
...
func (_m *BookService) Fetch(ctx context.Context) ([]entity.Book, error) {
	ret := _m.Called(ctx)
...
func (_m *BookService) FetchByID(ctx context.Context, id string) (entity.Book, error) {
...
func (_m *BookService) FetchByTitle(ctx context.Context, title string) ([]entity.Book, error) {
